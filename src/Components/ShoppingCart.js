    ...
    return (
        <div className="cartForm" >
            <div >
                ...
                <br></br>
                <div>
                    <center><button  id="1" className="view-btn" onClick={getShoppingCart} >Double-Click to View shopping cart items </button></center>
                    <h3 >Shopping Itmes:</h3>
                    <h4 > <i>{user.shoppingList.map(item => (<li> {item}</li>))} </i></h4>
                    <h4 >Total Fees: {user.totalFees}$</h4>
                    <div>
                        <br></br><br></br>
                        <center><button id="2" className="view-btn" onClick={postOrders}>Checkout </button></center>
                    </div>
                </div>
