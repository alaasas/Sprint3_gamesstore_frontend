        ...
        <div className="popup" >
            <div className="popup-inner">
                ...
                <div>
                    ...
                    <h4 className="des-content">Summary: <i> {gameSummary[6]}</i></h4>
                    <h4 className="des-content">Developers: {gameDevelopers[6]}</h4>
                    <h4 className="des-content">Genres: {gameGenres[6]}</h4>
                    <h4 className="des-content" >Price:$ {gamePrice[6]}</h4>
                    <div>
                        <br></br><br></br>
