  ...
  return (
    <div className="createAccount">
      <div className="CreateAccountForm">
        <h1 className="h1" test_id_h1="1">Create Your Account </h1>
        <label className=".label" test_id_fname= "2" htmlFor="fname">Full Name</label>
        <input test_id_fullname ="3" type="text" name="fullname" placeholder="Enter you full name" onChange={(event) => {
          setUserFullname(event.target.value);
        }} />
        <label className=".label" test_id_ename ="4" htmlFor="ename">Email ID</label>
        <input test_id_emailid ="5" type="text" name="emailid" placeholder="example@domain.com" onChange={(event) => {
          setEmail(event.target.value);
        }} />
        <label className=".label" test_id_pname="6" htmlFor="pname">Password</label>
