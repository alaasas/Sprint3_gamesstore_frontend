    ...
    return (props.trigger) ? (
        <div className="popup" >
            <div className="popup-inner">
                ...
                <div>
                    <center><img src={'https://assets-prd.ignimgs.com/2021/06/25/crash-drive-3-button-1624640707993.jpg?width=300'} alt="pic" /></center>
                    ...
                    <h4 className="des-content" >Price:$ {gamePrice[8]}</h4>
                    <div>
                        <br></br><br></br>
